...
Owner（fujiabao89）已于 **2026-08-08** 对 D01–D18 逐项给出决策，记录于下表（"Owner 决定"列）。**注意：这些是契约设计决策记录，契约本身仍为未接受提案**——未实施、未注册路由、未通过测试验收，不作为"已接受契约"；实施与测试由 WEB-35/36/37/38/39 承接。每个决策含：决策问题、推荐选项、备选项、权衡、下游影响。
