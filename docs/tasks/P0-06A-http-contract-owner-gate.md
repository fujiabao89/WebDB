...
>
> **阅读前须知**：文中"不得""必须"等措辞为**已接受契约**的约束（Owner 已接受 2026-08-13，尚未经实施/测试验收）；"目标态"专指 ADR-014/015 已接受但尚未实现的契约，不得理解为已实现。
