...
| [019](ADR-019-opencode-review-bounded-automation.md) | opencode 自动 PR 审查的受限自动化边界 | 已接受（ADR-020 拟替代，待 Owner 批准） |
| [020](ADR-020-opencode-review-trusted-execution.md) | opencode 自动审查的受信执行架构（拟替代 ADR-019） | 提议 |
